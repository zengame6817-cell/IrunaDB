...
function collectTotalData() {
  ...
  function openPicker(slotToken) {
    ...
    pickerList.classList.toggle("is-relic-grid", isRelicPicker);
    pickerSearchInput.placeholder = isRelicPicker ? "レリック名・効果で検索" : "装備名・効果で検索";
  ...
  function closePicker() {
    pickerModal.classList.remove("is-open", "is-relic-picker");
    pickerList.classList.remove("is-relic-grid");
